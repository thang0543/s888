...
INSERT INTO QUANLYVEMAYBAY.PROMOTION (ID, CODE, DESCRIPTION, DISCOUNT_TYPE, DISCOUNT_VALUE, MAX_DISCOUNT, MIN_FARE, AIRLINE_ID, ROUTE_ID, CUSTOMER_ID, START_DATE, END_DATE, IS_ACTIVE, CREATED_AT, UPDATED_AT)
VALUES (QUANLYVEMAYBAY.PROMOTION_SEQ.NEXTVAL, 'VOUCHER50', '50K VND off for VietJet flights', 'AMOUNT', 50000, 50000, 200000, 2, NULL, NULL, SYSTIMESTAMP, SYSTIMESTAMP + INTERVAL '15' DAY, 1, SYSTIMESTAMP, SYSTIMESTAMP);
